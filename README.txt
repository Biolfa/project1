Here is the first project of the course Manage your code with Git and GitHub - Part 2 - Share a repository on GitHub.

I create this initial file, README.txt.
After we have to create 2 others files. I chose to create index.html and bloc.css.

I did 4 commits :
- creation of  3 files in the repository
- change file index.html
- change file bloc.css
- change file readme.txt

Bellow this exercice, we have to create files and after once my repository named project1 create, I can push it to GitHub.


 You can find underbollow the exercice :
